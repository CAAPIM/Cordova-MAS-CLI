...
var __masForge  = {
    ...
    'forge': function (name, options) {
        ...
        shell.exec(command, function (code, stdout, stderr) {
            ...
            var platforms = options.ios ? 'https://github.com/apache/cordova-ios.git' : undefined;
                platforms = (platforms === undefined) ? ((options.android) ? 'android' : undefined) : ((options.android) ? platforms + ' android' : platforms);
                platforms = (platforms === undefined) ? ((process.platform === 'darwin') ? 'https://github.com/apache/cordova-ios.git' : 'android') : platforms;
